    ...
    <!--menu list-->
        <div class="row text-center" id="shoes" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="sketches/9.jpg" alt="" class="img-fluid pb-1">
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="sketches/10.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Draco</h6>
                            <h6>Price :Rs 7500</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="sketches/12.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h6>Handie Skull</h6>
                            <h6>Price :Rs 7000</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        <img src="sketches/13.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                        <h6>Legoo</h6>
                    <h6>Price :Rs 6000</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
