    ...
    <!--menu list-->
            <div class="row text-center" id="headphones">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
                            <img src="sketches/18.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Fairy Tale</h6>
                                <h6>Price :Rs 30,500</h6>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="sketches/19.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Mind Burst</h6>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="sketches/20.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Pattern</h6>
                                <h6>Price :Rs 24,500</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="sketches/21.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Dimensional</h6>
                                <h6>Price :Rs 25,000</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
