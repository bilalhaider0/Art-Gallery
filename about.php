...
<body style="overflow-x:hidden; padding-bottom:100px;">
    ...
    <div class="container mt-5 ">
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <p class="mt-2">To explore more visit the instagram page.</p>
		  <a href="https://www.instagram.com/sketcher_xo/" class="btn btn-warning btn-lg text-white">INSTAGRAM</a>
        </div>
  ...
  <div class="container mt-3 d-flex justify-content-center card pb-3 col-md-6">
    ...
    <form class="col-md-12" action="https://formspree.io/sketcherfreakx@gmail.com" method="POST" name="_next">
