...
<div class="container" style="margin-top:65px">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sketches</li>
            </ol>
        </nav>
        <!--breadcrumb end-->
    <hr/>
    ...
    <div class="row text-center" id="watch">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="sketches/1.jpg" alt="" class="img-fluid pb-1" >
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="sketches/2.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Witchie</h6>
                    <h6>Price :Rs 2500</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="sketches/3.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="sketches/4.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Skeleton</h6>
                    <h6>Price :Rs 1800</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
    ...
    <div class="row text-center" id="shirt">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="sketches/5.jpg" alt="" class="img-fluid pb-1"  >
                    <div class="figure-caption">
                    <h6>Dreamy</h6>
                    <h6>Price :Rs 1800</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="sketches/6.jpg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                    <h6>Kakashi</h6>
                    <h6>Price :Rs 2500</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="sketches/7.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Demon Slayer</h6>
                        <h6>Price :Rs 3000</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="sketches/8.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h6>Sasuke Uchiha</h6>
                        <h6>Price :Rs 2300</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
